...
const items = [
  {
    id: 1,
    title: 'PawMerge',
    img: '/projects/pawmerge.jpg',
    desc: 'Platform for the IT community where you can discuss ideas, find feedback from like-minded people, find partners and teams for project implementation, and also attract funding.',
    demo: 'https://pawmerge.com/',
  },
  {
    id: 2,
    title: 'Mutag-Haetz',
